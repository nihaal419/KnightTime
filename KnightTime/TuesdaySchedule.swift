...
class TuesdaySchedule: UIViewController{
    ...
    func timeManagement(){
        ...
        if(stringDay=="1"){finalDay="Today is Sunday"; imageView.image = UIImage(named:"Tuesday")}
        if(stringDay=="2"){finalDay="Today is Monday"; imageView.image = UIImage(named:"Tuesday")}
        if(stringDay=="3"){finalDay="Today is Tuesday"; imageView.image = UIImage(named:"Tuesday")}
        if(stringDay=="4"){finalDay="Today is Wednesday"; imageView.image = UIImage(named:"Tuesday")}
        if(stringDay=="5"){finalDay="Today is Thursday"; imageView.image = UIImage(named:"Tuesday")}
        if(stringDay=="6"){finalDay="Today is Friday"; imageView.image = UIImage(named:"Tuesday")}
        if(stringDay=="7"){finalDay="Today is Saturday"; imageView.image = UIImage(named:"Tuesday")}
        ...
        //TUE 2nd Period
        if(((hour==8 && (0...59).contains(minute))||(hour==9&&(00...14).contains(minute)))){finalPeriod=secondPeriod; finalNext="Next: Advisory"}
        else if(hour==9 && (15...19).contains(minute)){finalPeriod="Passing Period"; finalNext="Next: Advisory"}
            //TUE ADVISORY
        else if((hour==9 && (20...39).contains(minute))){finalPeriod="Advisory"; finalNext="Next: Chapel"}
        else if((hour==9 && (40...44).contains(minute))){finalPeriod="Passing Period"; finalNext="Next: Chapel"}
            //TUE Chapel/Break
        else if(((hour==9 && (45...59).contains(minute))||(hour==10&&(00...24).contains(minute)))){finalPeriod="Chapel/Break"; finalNext="Next: "+thirdPeriod}
        else if(hour==10 && (25...29).contains(minute)){finalPeriod="Passing Period"; finalNext="Next: "+thirdPeriod}
            //TUE 3rd Period
        else if(((hour==10 && (30...59).contains(minute))||(hour==11&&(00...44).contains(minute)))){finalPeriod=thirdPeriod; finalNext="Next: "+fifthPeriodA}
            ...
            //TUE 5B
        else if(((hour==12 && (40...59).contains(minute))||(hour==13&&(00...24).contains(minute)))){finalPeriod=fifthPeriodB; finalNext="Next: "+firstPeriod}
        else if(hour==13 && (25...29).contains(minute)){finalPeriod="Passing Period"; finalNext="Next: "+firstPeriod}
            //TUE 1st Period
        else if(((hour==13 && (30...59).contains(minute))||(hour==14&&(00...44).contains(minute)))){finalPeriod=firstPeriod; finalNext="Next: Tutorials"}
