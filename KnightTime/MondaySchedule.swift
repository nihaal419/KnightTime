...
class MondaySchedule: UIViewController{
    ...
    func timeManagement(){
        ...
        if(stringDay=="1"){finalDay="Today is Sunday"; imageView.image = UIImage(named:"Mon")}
        if(stringDay=="2"){finalDay="Today is Monday"; imageView.image = UIImage(named:"Mon")}
        if(stringDay=="3"){finalDay="Today is Tuesday"; imageView.image = UIImage(named:"Mon")}
        if(stringDay=="4"){finalDay="Today is Wednesday"; imageView.image = UIImage(named:"Mon")}
        ...
        if(stringDay=="7"){finalDay="Today is Saturday"; imageView.image = UIImage(named:"Mon")}
        ...
        if((hour==8 && (0...44).contains(minute))){finalPeriod=firstPeriod; finalNext="Next: "+secondPeriod}
        else if((hour==8 && (45...49).contains(minute))){finalPeriod="Passing Period"; finalNext="Next: "+secondPeriod}
            //MON/THUR/FRI 2nd Period
        else if(((hour==8&&(50...59).contains(minute))||(hour==9&&(00...34).contains(minute)))){finalPeriod=secondPeriod; finalNext="Next: Chapel"}
        else if((hour==9 && (35...39).contains(minute))){finalPeriod="Passing Period"; finalNext="Next: Chapel"}
            //MON/THUR/FRI Chapel/Break
        else if(((hour==9&&(40...59).contains(minute))||(hour==10&&(00...14).contains(minute)))){finalPeriod="Chapel/Break"; finalNext="Next: "+thirdPeriod}
        else if((hour==10 && (15...19).contains(minute))){finalPeriod="Passing Period"; finalNext="Next: "+thirdPeriod}
            //MON/THUR/FRI 3rd Period
        else if(((hour==10&&(20...59).contains(minute))||(hour==11&&(00...04).contains(minute)))){finalPeriod=thirdPeriod; finalNext="Next: "+fourthPeriod}
        else if((hour==11 && (05...09).contains(minute))){finalPeriod="Passing Period"; finalNext="Next: "+fourthPeriod}
            //MON/THUR/FRI 4th Period
        else if((hour==11 && (10...54).contains(minute))){finalPeriod=fourthPeriod; finalNext="Next: "+fifthPeriodA}
        else if(hour==11 && (55...59).contains(minute)){finalPeriod="Passing Period"; finalNext="Next: "+fifthPeriodA}
            //MON/THUR/FRI 5A
        else if((hour==12 && (00...44).contains(minute))){finalPeriod=fifthPeriodA; finalNext="Next: "+fifthPeriodB}
        else if((hour==12 && (45...49).contains(minute))){finalPeriod="Passing Period"; finalNext="Next: "+fifthPeriodB}
            //MON/THUR/FRI 5B
        else if(((hour==12&&(50...59).contains(minute))||(hour==13&&(00...34).contains(minute)))){finalPeriod=fifthPeriodB; finalNext="Next: "+sixthPeriod}
        else if((hour==13 && (35...39).contains(minute))){finalPeriod="Passing Period"; finalNext="Next: "+sixthPeriod}
            //MON/THUR/FRI 6th Period
        else if(((hour==13&&(40...59).contains(minute))||(hour==14&&(00...24).contains(minute)))){finalPeriod=sixthPeriod; finalNext="Next: "+seventhPeriod}
        else if((hour==14 && (25...29).contains(minute))){finalPeriod="Passing Period"; finalNext="Next: "+seventhPeriod}
            //MON/THUR/FRI 7th Period
        else if(((hour==14&&(30...59).contains(minute))||(hour==15&&(00...14).contains(minute)))){finalPeriod=seventhPeriod; finalNext="Next: Tutorials"}
        else if((hour==15 && (15...19).contains(minute))){finalPeriod="Passing Period"; finalNext="Next: Tutorials"}
            //MON/THUR/FRI Tutorials
        else if((hour==15 && (20...59).contains(minute))){finalPeriod="Tutorials"; finalNext="End of School"}
        else if((((16...24).contains(hour))||((1...6).contains(hour)))){finalPeriod="Enjoy Your Day"; finalNext="School is Over"}
